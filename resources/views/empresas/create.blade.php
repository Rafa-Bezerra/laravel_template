            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">    
                <form method="POST" action="{{ route('empresas.insert') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="fantasia" class="block mt-1 w-full" type="text" name="fantasia" :value="old('fantasia')"  />
                    ...
                    <div>
                        ...
                        <x-select-input id="pessoa" class="block mt-1 w-full" name="pessoa" :value="old('pessoa')">
                            <option></option>
